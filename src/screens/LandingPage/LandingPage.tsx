    ...
    <div className="bg-white w-full min-h-screen relative overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-12">
          <Button className="flex items-center gap-3 bg-[#b6ff76] hover:bg-[#a5ee65] rounded-full border-4 md:border-[7px] border-[#13192a] px-8 md:px-12 py-4 md:py-6 h-auto">
      ...
      <nav className="fixed top-4 left-4 right-4 md:left-8 md:right-auto md:w-auto z-50 bg-[#ffffffcc] rounded-3xl border border-solid border-[#a0a0a08c] shadow-[0px_4px_62.3px_#0000002b] backdrop-blur-[2px]">
        <div className="flex items-center gap-4 md:gap-6 px-4 py-3">
          ...
          <Button
            variant="outline"
            className="ml-auto bg-[#dcffba] hover:bg-[#cbee99] rounded-full border-2 md:border-[3px] border-[#13192a] px-4 md:px-6 py-2 h-auto"
          >
      ...
      <section id="contact" className="px-4 md:px-8 lg:px-16 py-20 max-w-7xl mx-auto">
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex items-center gap-3 bg-[#b6ff76] rounded-full border-4 md:border-[7px] border-[#13192a] px-8 md:px-12 py-4 md:py-6">
              <span className="[font-family:'Space_Mono',Helvetica] font-bold text-[#13192a] text-2xl md:text-4xl">
                TRY
              </span>
              <img className="w-6 h-6 md:w-8 md:h-8" alt="Forward" src="/fi-br-forward.svg" />
